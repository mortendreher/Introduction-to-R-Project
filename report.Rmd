...
For Germany, the most recent data available describes new cases and mortality in 2017. In this year, 6040 men and 2903 women were diagnosed with liver cancer and 5213 men and 2697 women of the cancer deaths were associated with liver cancer.
...
The whole project was programmed and thought out as a team, except some minor excpetions at the end of the project. In the last phase of the project I was responsible for adding and implementing an R Markdown file, containing the information about our chosen cancer type as well as outsorcing our code which was used on multiple occacions in a global R script. Other minor tasks were script cleaning and displaying the boxplot grouping variable by colour in the plot.
